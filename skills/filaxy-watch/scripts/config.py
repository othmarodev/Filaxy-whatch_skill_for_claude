#!/usr/bin/env python3
"""Shared /filaxy-watch configuration helpers."""
...
def read_env_file(path: Path | None = None) -> dict[str, str]:
    ...
    for line in lines:
        ...
        if len(value) >= 2 and value[0] in ('"', "'") and value[-1] == value[0]:
            ...
            # unquoted value. Without this, `FILAXY_WATCH_DETAIL=balanced  # note`
...
def get_config() -> dict[str, object]:
    ...
    detail = (
        os.environ.get("FILAXY_WATCH_DETAIL")
        or file_values.get("FILAXY_WATCH_DETAIL")
        or DEFAULT_DETAIL
    )
