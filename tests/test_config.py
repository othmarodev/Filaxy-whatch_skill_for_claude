"""FILAXY_WATCH_DETAIL resolution and frame_cap mapping."""
...
def test_default_detail_is_balanced(monkeypatch, tmp_path):
    monkeypatch.delenv("FILAXY_WATCH_DETAIL", raising=False)
